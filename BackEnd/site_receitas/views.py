...
class CadastroUsuario(APIView):
    ...
    def get(self, request, format=None):
        renderer_classes = (TemplateHTMLRenderer,)
        return Response({}, template_name='cadastroUsuario.html')
...
class CadastroReceita(APIView):
    ...
    def get(self, request, format=None):
        ...
        if request.user.is_authenticated:
            return Response({}, template_name='cadastroReceita.html')
        else:
            context = {'errors': 'É necessário entrar para cadastrar uma receita.'}
            return Response(context, template_name='entrar.html')
...
class ExibirReceitasBebidas(APIView):
    ...
    def get(self, request, format=None):
        ...
        return Response({'bebidas': serializer.data}, template_name='bebidas.html')


class DetalheReceita(APIView):
    ...
    def get(self, request, id, tipo='', format=None):
        ...
        if tipo == 'xml':
            return Response({'receita': serializer.data}, template_name='receita.xml', content_type="application/xhtml+xml")
        elif tipo == 'simples':
            return Response({'receita': serializer.data}, template_name='simples.html')
        else:
            return Response({'receita': serializer.data}, template_name='detalheReceita.html')
